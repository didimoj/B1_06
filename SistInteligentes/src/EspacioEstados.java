...
public Estado crearEstado(ArrayList<int[]> l, Acciones a,Estado e) {
		...
		//	System.arraycopy(getTerreno().getTerreno()[f], 0, nuevo[f], 0, nuevo[f].length);
...
*/
	...
	public static ArrayList<int[]> crearLista(Estado e) {
		...
		// entre dos casillas y meterlas en una lista
		...
		else if (e.getTractorX() == 0 && e.getTractorY() != 0 && e.getTractorY() != e.getTerreno().size()) { // Lateral izquierdo
			lista.add(new int[] { e.getTractorX(), (e.getTractorY() - 1) });
			lista.add(new int[] { e.getTractorX(), (e.getTractorY() + 1) });
			lista.add(new int[] { (e.getTractorX() + 1), e.getTractorY() });
		...
		} else if (e.getTractorX() == e.getTerreno().size() && e.getTractorY() != 0 && e.getTractorY() != e.getTerreno().size()) { // Lateral derecho
			lista.add(new int[] { e.getTractorX(), (e.getTractorY() - 1) });
			lista.add(new int[] { e.getTractorX(), (e.getTractorY() + 1) });
			lista.add(new int[] { (e.getTractorX() - 1), e.getTractorY() });
			...
			// de esta forma tendria tres sitios donde colocar tierra
			// hacer que se pueda cojer y las combinaciones
		} else if (e.getTractorY() == e.getTerreno().size() && e.getTractorX() != 0 && e.getTractorX() != e.getTerreno().size()) { // Abajo
			lista.add(new int[] { (e.getTractorX() - 1), e.getTractorY() });
			lista.add(new int[] { (e.getTractorX() + 1), e.getTractorY() });
			lista.add(new int[] { e.getTractorX(), (e.getTractorY() - 1) });
